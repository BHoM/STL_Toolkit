...
namespace BH.Engine.Adapters.STL
{
    public static partial class Query
    {
        ...
        [Output("partiallyContainer", "True if at least one of the provided points is contained by the polyline, false if none of the points are.")]
        public static bool PartiallyContains(this Polyline polyline, List<Point> points, bool acceptOnEdge = false)
        {
